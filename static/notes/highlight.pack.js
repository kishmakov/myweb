...
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
name:"TypeScript",aliases:["ts","tsx"]}),b}})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
},n.inherit(s,{relevance:0})]}}})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},r,s]}}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
...
},...B,...k,...S,I,K,...z,...q,U,G]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
